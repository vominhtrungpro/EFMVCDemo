...
namespace EFMVCDemo.Controllers
{
    public class StudentSubjectsController : Controller
    {
        ...
        {
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "StudentAddress");
            ViewData["SubjectId"] = new SelectList(_context.Subject, "SubjectId", "SubjectDetail");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,SubjectId")] StudentSubject studentSubject)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "StudentAddress", studentSubject.StudentId);
            ViewData["SubjectId"] = new SelectList(_context.Subject, "SubjectId", "SubjectDetail", studentSubject.SubjectId);
            return View(studentSubject);
        }
